...
const TEST_SITES = [
  ...
  'https://ostoria.fr/',
  'https://www.hotel-ours-blanc.com/',
  'https://hotel-oursblanc.com/',
  'http://www.oustaucamarguen.com/',
];
  ...
  try {
    ...
    if (data?.phones) {
      for (const phone of data.phones) {
        ...
        // Vérifie les fax
        if (/(fax|télécopie|facsimile)/i.test(phone.snippet || '')) {
...
async function main() {
  ...
  console.log('🚀 Démarrage des tests sur les sites d\'hôtels (emails, phones, socials uniquement)...');
